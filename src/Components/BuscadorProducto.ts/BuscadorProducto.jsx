...
export const BuscadorProductos = () => {
  ...
  const obtenerTodosLosProductos = async () => {
    try {
      const res = await axios.get("https://quindishoes-backend-3.onrender.com/producto/public");
  ...
  const buscarProductos = async () => {
    try {
      const res = await axios.post("https://quindishoes-backend-3.onrender.com/buscadorProducto", { nombre, ...filtros });
      setProductos(res.data);
    } catch (err) {
