...
const PaymentBrick = React.memo(() => {
  ...
  useEffect(() => {
    const fetchPreferenceId = async () => {
      try {
        const response = await fetch("https://quindishoes-backend-3.onrender.com/api/create_preference", {
          method: "POST",
      ...
      await bricksBuilder.create("payment", "payment-brick-container", {
        ...
        callbacks: {
          ...
          onSubmit: async ({ selectedPaymentMethod, formData }) => {
            ...
            const response = await fetch("https://quindishoes-backend-3.onrender.com/api/process_payment", {
              method: "POST",
              headers: {
          ...
          onPaymentApproved: async (payment) => {
            ...
            fetch("https://quindishoes-backend-3.onrender.com/api/process_payment", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
